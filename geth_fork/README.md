## Note:
Just read about `debug_traceMultiCall` here. I don't understand geth or golang but I somehow managed to add this for my purposes of simulating blocks.
See `geth_fork/bsc_sandwich_mod/eth/tracers/api.go` , `Line 894` for implementation.
